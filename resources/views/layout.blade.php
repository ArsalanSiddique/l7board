        ...
        <div class="site-footer">
            <div class="container">
                ...
                <div class="site-footer__bottom">
                    <div class="site-footer__copyright">Design & Developed by <a target="_blank" href="#">Arsalan Ahmed <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__compare" type="button"><svg width="16px" height="16px">
                                    <use xlink:href="{{ asset('/storage/images/sprite.svg#compare-16') }}"></use>
                                </svg> <span class="fake-svg-icon fake-svg-icon--compare-16"></span></button></a></div>
