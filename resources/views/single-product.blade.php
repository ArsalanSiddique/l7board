                ...
                <div class="product product--layout--columnar" data-layout="columnar">
                    <div class="product__content">
                        ...
                        <div class="product__gallery">
                            <div class="product-gallery">
                                <div class="product-gallery__featured">
                                    <div class="owl-carousel" id="product-image"><a href="{{ asset('/storage/images/'.$product->photo) }}" target="_blank"><img src="{{ asset('/storage/images/'.$product->photo) }}" alt=""> </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="product__sidebar">
                            <div class="product__availability">Availability: @if($product->product_stock($product->id) > 0) <span class="text-success">In Stock</span> @else <span class="text-danger">Out Of Stock</span> @endif </div>
                            ...
                            <form class="product__options">
                                ...
                                <div class="form-group product__option"><label class="product__option-label">Material</label>
                                    <div class="input-radio-label">
                                        <div class="input-radio-label__list"><label><input type="radio" name="material"> <span>{{ $product->material }}</span></label></div>
                                    </div>
                                </div>
