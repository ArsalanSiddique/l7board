                        ...
                        <div class="product__content">
                            ...
                            <div class="product__gallery">
                                <div class="product-gallery">
                                    <div class="product-gallery__featured">
                                        <div class="owl-carousel" id="product-image"><a href="{{ asset('/storage/images/'.$product->photo) }}" target="_blank"><img src="{{ asset('/storage/images/'.$product->photo) }}" alt=""> </a><a href="images/products/product-16-1.html" target="_blank"><img src="images/products/product-16-1.jpg" alt=""> </a><a href="images/products/product-16-2.html" target="_blank"><img src="images/products/product-16-2.jpg" alt=""> </a><a href="images/products/product-16-3.html" target="_blank"><img src="images/products/product-16-3.jpg" alt=""> </a><a href="images/products/product-16-4.html" target="_blank"><img src="{{ asset('/storage/images/'.$product->photo) }}" alt=""></a></div>
                                    </div>
                                </div>
                            ...
                            <div class="product__footer">
                                <div class="product__tags tags">
                                    <div class="tags__list"><a href="#">{{ $product->category->name }}</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="product-tabs">
                        <div class="product-tabs__list"><a href="#tab-description" class="product-tabs__item product-tabs__item--active">Description</a> <a href="#tab-reviews" class="product-tabs__item">Reviews</a></div>
                            ...
                            <div class="block-products-carousel__column">
                                <div class="block-products-carousel__cell">
                                    <div class="product-card"><button class="product-card__quickview" type="button"><svg width="16px" height="16px">
                                        ...
                                        <div class="product-card__image"><a href="{{ route('product-view', $rel_product->id) }}"><img src="{{ asset('/storage/images/'.$rel_product->photo) }}" alt=""></a></div>
                                        <div class="product-card__info">
                                            <div class="product-card__name"><a href="{{ route('product-view', $rel_product->id) }}">{{ $rel_product->name }}</a></div>
                                        ...
                                        <div class="product-card__actions">
                                            ...
                                            <div class="product-card__prices">$ {{ $rel_product->price }}</div>
